...
import com.sonicle.dav.caldav.impl.CalDavImpl;
...
public class CalDavFactory {
	 ...
	 * @return 
	 */
	public static CalDav begin(String username, String password) {
	 ...
	 * @return 
	 */
	public static CalDav begin(String username, String password, ProxySelector proxy) {
		return new CalDavImpl(username, password, proxy);
	}
}
